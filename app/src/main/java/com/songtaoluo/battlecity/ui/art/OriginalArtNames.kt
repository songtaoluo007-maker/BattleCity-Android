...
object OriginalArtNames {
    fun vehicle(id: VehicleId): String = when (id) {
    ...
    fun campaign(id: String): String = when (id) {
    ...
    fun medal(id: String, unlocked: Boolean): String =
        "medal_${id}" + if (unlocked) "" else "_locked"

    fun result(victory: Boolean): String =
